  ...
  <div class="swiper-banner swiper-container swiper-container-horizontal">
    <div class="swiper-slide header EC5 swiper-slide-duplicate swiper-slide-active test">
      <div class="xe-banner3 w1200">
        <div class="bigTitle T1 mb8">科技驱使，创新无止</div>
      ...
      <div class="product-items">
          ...
          <div class="product-item">
              ...
              <div class="product-info">
                  <div class="info-item">
                      <!-- <div class="icon_img">
                          <img src="/images/homePage/zxjy_icon_1.png" data-rjs="2" alt="商家学院,在线教育平台"/>
                      </div>                            -->
                  ...
                  <div class="info-item">
                      <!-- <div class="icon_img">
                          <img src="/images/homePage/zxjy_icon_2.png" data-rjs="2" alt="商家学院,在线教育平台"/>
                      </div>                            -->
                  ...
                  <div class="info-item">
                      <!-- <div class="icon_img">
                          <img src="/images/homePage/zxjy_icon_3.png" data-rjs="2" alt="商家学院,在线教育平台"/>
                      </div>                            -->
                  ...
                  <div class="info-item">
                      <!-- <div class="icon_img">
                          <img src="/images/homePage/zxjy_icon_4.png" data-rjs="2" alt="商家学院,在线教育平台"/>
                      </div>                            -->
                      <h3 class="subtitle">关联公众号</h3>
                      <p class="desc">双管齐下，让用户多一种体验，多一种渠道</p>
                  </div>
                  <div class="btn_a">
                      <a href="http://mini.hich-tech.com" class="link-detail">开始制作</a>
                  </div>
              </div>
          </div>
      </div>
      <div class="product-items">
          ...
          <div class="product-item">
              ...
              <div class="product-info">
                  <div class="info-item">
                      <!-- <div class="icon_img">
                          <img src="/images/homePage/zsff_icon_1.png" data-rjs="2" alt="商家学院,在线教育平台"/>
                      </div>                            -->
                  ...
                  <div class="info-item">
                      <!-- <div class="icon_img">
                          <img src="/images/homePage/zsff_icon_2.png" data-rjs="2" alt="商家学院,在线教育平台"/>
                      </div>                            -->
                  ...
                  <div class="info-item">
                      <!-- <div class="icon_img">
                          <img src="/images/homePage/zsff_icon_3.png" data-rjs="2" alt="商家学院,在线教育平台"/>
                      </div>                            -->
                  ...
                  <div class="info-item">
                      <!-- <div class="icon_img">
                          <img src="/images/homePage/zsff_icon_4.png" data-rjs="2" alt="商家学院,在线教育平台"/>
                      </div>                            -->
                      <h3 class="subtitle">丰富的配套服务</h3>
                      <p class="desc">为商家提供地图标注，图文设计等一站式服务</p>
                  </div>
                  <div class="btn_a">
                      <a href="/mobile/pages/website" class="link-detail">了解详情</a>
                  </div>
              </div>
          </div>
      </div>
      <div class="product-items">
          ...
          <div class="product-item">
              ...
              <div class="product-info">
                  ...
                  <div class="btn_a">
                      <a href="/mobile/pages/customize" class="link-detail">沟通需求</a>
                  </div>
              </div>
          </div>
      </div>
  ...
  <div class="extend-read">
      ...
      <div class="extend-read-list">
          ...
          <a class="extend-read-item" href="/mobile/pages/hotNews/news2">
              ...
              <div class="read-item-time">2019-06-26 13:40:57</div>
          </a>
      </div>
  </div>
  <div class="foot_free">
